...
export function HeroHeader () {
  ...
  return (
    <div className="block md:hidden h-[26rem] w-full rounded-md flex md:items-center md:justify-center bg-current/[0.96] antialiased bg-grid-white/[0.02] relative overflow-hidden">
